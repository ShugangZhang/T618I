...
#define VENTRICLE
#define EPSILON 1e-7
#define MCELL1 // MUST BE COMMENTED OUT IF CELL IS NOT VENTRICLE MYOCYTE.
...
int main(int argc, char *argv[])
{
	...
	double BCL = 800; // ms   // NOTE THERE ARE TWO INIT FILES TO BE CHANGED!!!
	...
	initfile = fopen("SingleCell/TP06InitialValues_QUIN_EPI.dat","r"); // NOTE THERE ARE TWO INIT FILES TO BE CHANGED!!!
