...
int main(int argc, char *argv[])
{
	...
	#ifdef CON
	FILE *rcfile = fopen("Outputs/RestCurve_CON_S1S2.dat","w+");
	#endif

	#ifdef SQT1
	FILE *rcfile = fopen("Outputs/RestCurve_SQT1_S1S2.dat","w+");
	#endif

	#ifdef QUIN
	FILE *rcfile = fopen("Outputs/RestCurve_QUIN_S1S2.dat","w+");
	#endif
