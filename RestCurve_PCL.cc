...
int main(int argc, char *argv[])
{
	...
	#ifdef CON
	FILE *rcfile = fopen("Outputs/RestCurve_CON_PCL.dat","w+");
	#endif

	#ifdef SQT1
	FILE *rcfile = fopen("Outputs/RestCurve_SQT1_PCL.dat","w+");
	#endif

	#ifdef QUIN
	FILE *rcfile = fopen("Outputs/RestCurve_QUIN_PCL2.dat","w+");
	#endif
